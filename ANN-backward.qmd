...
::: {#fig-annBack4 layout-nrow=2 .column-page}

![](image/annBack3.png){width=70%}

![](image/annBack4.png){width=70%}
...
::: {#fig-annBack5 layout-nrow=2 .column-page}

![](image/annBack5.png){width=70%}

![](image/annBack6.png){width=70%}
